...
MinimumCode-Linux-Debug:
	 $(PROJECTBUILD) MinimumCode Linux Debug  -project="$(GAMEPROJECTFILE)" $(ARGS)

MinimumCode-Linux-DebugGame:
	 $(PROJECTBUILD) MinimumCode Linux DebugGame  -project="$(GAMEPROJECTFILE)" $(ARGS)

MinimumCode-Linux-Shipping:
	 $(PROJECTBUILD) MinimumCode Linux Shipping  -project="$(GAMEPROJECTFILE)" $(ARGS)

MinimumCode-Linux-Test:
	 $(PROJECTBUILD) MinimumCode Linux Test  -project="$(GAMEPROJECTFILE)" $(ARGS)

MinimumCode:
	 $(PROJECTBUILD) MinimumCode Linux Development  -project="$(GAMEPROJECTFILE)" $(ARGS)

MinimumCodeEditor-Linux-Debug:
	 $(PROJECTBUILD) MinimumCodeEditor Linux Debug  -project="$(GAMEPROJECTFILE)" $(ARGS)

MinimumCodeEditor-Linux-DebugGame:
	 $(PROJECTBUILD) MinimumCodeEditor Linux DebugGame  -project="$(GAMEPROJECTFILE)" $(ARGS)

MinimumCodeEditor-Linux-Shipping:
	 $(PROJECTBUILD) MinimumCodeEditor Linux Shipping  -project="$(GAMEPROJECTFILE)" $(ARGS)

MinimumCodeEditor-Linux-Test:
	 $(PROJECTBUILD) MinimumCodeEditor Linux Test  -project="$(GAMEPROJECTFILE)" $(ARGS)

MinimumCodeEditor:
	 $(PROJECTBUILD) MinimumCodeEditor Linux Development  -project="$(GAMEPROJECTFILE)" $(ARGS)

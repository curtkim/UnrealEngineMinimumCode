...
unrealRootPath=/home/curt/UnrealEngine_4.22
MinimumCodeRootPath=/data/unreal_projects/MinimumCode

gameProjectFile=/data/unreal_projects/MinimumCode/MinimumCode.uproject
...
include(MinimumCodeSource.pri)
include(MinimumCodeHeader.pri)
include(MinimumCodeConfig.pri)
include(MinimumCodeIncludes.pri)
include(MinimumCodeDefines.pri)

MinimumCode-Linux-Debug.commands = $$build MinimumCode Linux Debug  -project="\"$$gameProjectFile\"" $$args
MinimumCode-Linux-DebugGame.commands = $$build MinimumCode Linux DebugGame  -project="\"$$gameProjectFile\"" $$args
MinimumCode-Linux-Shipping.commands = $$build MinimumCode Linux Shipping  -project="\"$$gameProjectFile\"" $$args
MinimumCode-Linux-Test.commands = $$build MinimumCode Linux Test  -project="\"$$gameProjectFile\"" $$args
MinimumCode.commands = $$build MinimumCode Linux Development  -project="\"$$gameProjectFile\"" $$args

MinimumCodeEditor-Linux-Debug.commands = $$build MinimumCodeEditor Linux Debug  -project="\"$$gameProjectFile\"" $$args
MinimumCodeEditor-Linux-DebugGame.commands = $$build MinimumCodeEditor Linux DebugGame  -project="\"$$gameProjectFile\"" $$args
MinimumCodeEditor-Linux-Shipping.commands = $$build MinimumCodeEditor Linux Shipping  -project="\"$$gameProjectFile\"" $$args
MinimumCodeEditor-Linux-Test.commands = $$build MinimumCodeEditor Linux Test  -project="\"$$gameProjectFile\"" $$args
MinimumCodeEditor.commands = $$build MinimumCodeEditor Linux Development  -project="\"$$gameProjectFile\"" $$args
...
QMAKE_EXTRA_TARGETS += \ 
	MinimumCode-Linux-Debug \
	MinimumCode-Linux-DebugGame \
	MinimumCode-Linux-Shipping \
	MinimumCode-Linux-Test \
	MinimumCode \
	MinimumCodeEditor-Linux-Debug \
	MinimumCodeEditor-Linux-DebugGame \
	MinimumCodeEditor-Linux-Shipping \
	MinimumCodeEditor-Linux-Test \
	MinimumCodeEditor \
